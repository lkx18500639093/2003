...
import com.umeng.lkx.adapter.JingYanAdapter;
...
public class Qrament extends Fragment implements TongView {
    private RecyclerView jing;
    private ArrayList<JingYanBean.DataBean.ExpTopBean.ListBean> listBeans;
    private JingYanAdapter adapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.jingyan, null);
        initView(view);
    ...
    private void initView(View view) {
         ...
         jing.setLayoutManager(new LinearLayoutManager(getContext()));
        listBeans = new ArrayList<>();
        adapter = new JingYanAdapter(getContext(), listBeans);
        jing.setAdapter(adapter);
    }
